...
public class EscogenciaCatalogos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Catálogos Disponibles:");
        ...
        jButton2.setText("Catálogo de Deportistas");
        jButton2.setToolTipText("Catálogo de Deportistas");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 90, 230, 60));

        jButton3.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        jButton3.setText("Catálogo de Padres de Familia");
        jButton3.setToolTipText("Catálogo de Padres de Familia");
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 180, 230, 60));

        jButton4.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        jButton4.setText("Catálogo de Deportes");
        jButton4.setToolTipText("Catálogo de Deportes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EscogenciaCatalogos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EscogenciaCatalogos().setVisible(true);
            }
        });
    }
