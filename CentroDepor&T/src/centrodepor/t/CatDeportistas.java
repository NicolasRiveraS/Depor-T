...
public class CatDeportistas extends javax.swing.JFrame {
    ...
    // Atributos
    private LinkedList<CatalogoDeportistas> catDeportistas;
    ...
    public void agregarDeportistas() {
        try {
            if (camposVacios()) {
                ...
                catDeportistas.add(cD);
                
                DataOutputStream salida = new DataOutputStream(new FileOutputStream(
                        "deportistas.dat", true));
                
                salida.writeLong(cD.getID());
                salida.writeUTF(cD.getNombre());
                salida.writeUTF(cD.getPrimerApellido());
                salida.writeUTF(cD.getSegundoApellido());
                salida.writeUTF(cD.getCiudad());
                salida.writeUTF(cD.getDireccion());
                salida.writeUTF(cD.getTelefono());
                salida.writeUTF(cD.getCorreo());
                salida.writeUTF(cD.getEstado());
